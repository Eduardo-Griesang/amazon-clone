    ...
    return(
        <div id="carouselExampleCaptions" class="carousel slide">
            <div class="carousel-indicators">
                <button type="button" data-bs-target="#carouselExampleCaptions" class="indicators active" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1"></button>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active movie-info">
                    <img class='d-block movie-banner w-100' src="https://m.media-amazon.com/images/S/sonata-images-prod/SVOD_LATCANZ_Air_Launch_Concept_CS/69fec07f-e6ad-4de4-9955-a445c62f50fc._UR3840,1440_SX2160_FMwebp_.jpeg" alt="..."/>
                    <div class="datails-movie">
